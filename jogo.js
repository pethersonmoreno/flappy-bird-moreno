const mount = (parentElement, urlBase = '.', userInteractionElement = window)=>{
    ...
    loop();
    userInteractionElement.addEventListener('click', listenerClick);
    userInteractionElement.addEventListener ('keydown', listenerKeyDown);
    return () => {
        parentElement.removeChild(canvas);
        userInteractionElement.removeEventListener('click', listenerClick);
        userInteractionElement.removeEventListener ('keydown', listenerKeyDown);
    }
}

window.mountFlappyBird = mount;